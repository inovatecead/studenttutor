...
class assignment_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_assignment_created', 'local_studenttutor');
    }

    public function get_description() {
        return "The user with id '{$this->userid}' created a student-tutor assignment with id '{$this->objectid}'.";
    }
